...
export const PROVIDERS: ProviderConfig[] = [
  ...
  },
  {
    ...
    logo: "✨",
    description: "Multimodal streaming with intelligent VAD (native audio model)",
    ...
    costPerMinute: "$0.30",
    latencyRange: "~200ms",
    features: ["Native audio model", "Built-in VAD", "24 languages", "30 HD voices"],
  },
  {
    id: "gemini3",
    name: "Gemini 3 Flash",
    shortName: "Gemini 3",
    logo: "⚡",
    description: "Frontier-class reasoning at Flash speed (gemini-3-flash-preview)",
    realtimeEndpoint: "https://generativelanguage.googleapis.com/v1beta",
    realtimeAuth: { type: "query-param" },
    asyncEndpoint: "https://generativelanguage.googleapis.com/v1beta",
    asyncAuth: { type: "query-param" },
    supportedLanguages: SUPPORTED_LANGUAGES.map((l) => ({ ...l })),
